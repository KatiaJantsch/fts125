...
public class BuscaExtra {
	String url;
	WebDriver driver;
	String nomePasta = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss").format(Calendar.getInstance().getTime());
	...
	public void Print(String nomePrint) throws IOException {
		...
		FileUtils.copyFile(foto, new File("C:\\Users\\katia\\eclipse-workspace\\Extra\\target\\evidencias\\" + nomePasta + "\\" + nomePrint + ".png"));
	}
	...
	public void Iniciar() {
		...
		"C:\\Users\\katia\\eclipse-workspace\\Extra\\drivers\\chrome\\79\\chromedriver.exe");
	...
	@Given("^preencho o termo \"([^\"]*)\" e clico na Lupa$")
	...
	public void exibe_a_mensagem_de_produto_nao_encontrado() throws Throwable {
	    ...
	    //assertEquals("Smartphone", driver.findElement(By.cssSelector("ul.neemu-breadcrumb-container")).getText());
		Print("Passo 3.n - Exibiu a mensagem de falha");
	 }
}
